...
export default function Project({data}) {
  ...
  return (
    ...
    <Card className=''> 
        <CardHeader 
            title='Testing'
            subheader={<p><strong>Expire:</strong> {data.duration}</p>}
            avatar={
        ...
        <CardContent>
            ...
            <Box
                ...
                sx={{width: '25ch'}}
            >
               {data.status !== 'Successful' && <div className='flex justify-between pb-10'>
            ...
            <ProgressBar variant="determinate" value={60} givenAmount={data.amount} goal={data.goalAmount} />
        </CardContent>
    </Card>
    </div>
  )
